...
/*#__PURE__*/
function (_Component) {
  _inherits(HalfRing, _Component);

  function HalfRing() {
    _classCallCheck(this, HalfRing);

    return _possibleConstructorReturn(this, _getPrototypeOf(HalfRing).apply(this, arguments));
  }

  _createClass(HalfRing, [{
    key: "render",
    value: function render() {
      return _react["default"].createElement("div", {
        className: "phone__halfring"
